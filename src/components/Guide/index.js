  ...
  return (
    ...
    <div className="guide">
      ...
      <div className="guide__presentation animate__animated animate__fadeInRight">
        <h2 className="guide__presentation__title">Tu souhaites découvrir ce milieu fabuleux qu'est l'astronomie ?!</h2>
        <h3 className="guide__presentation__sous-title">Oui ? Alors t'es au bon endroit !</h3>
        <div className="guide__presentation__paragraphe">
          <p>Laisse moi t'expliquer un peu comment tout ce bazard, qu'est l'astronomie amateur, fonctionne ! (Faut bien commencer quelque part, non ?!)</p>
          <p>Dans le milieu de l'astronomie 'visuel' (Oui, j'ai bien dit visuel, ce détail a son importance !)</p>
          ...
          <p>Eh bah tu fais bien de me demander Jean-Michel question (pardon pour les Jean-Michel)</p>
          ...
          <p>Pour cela, il faut se laisser environ 15 minutes pour que notre oeil se fasse à l'obscurité,
            la pupille va se dilater et son diamètre quadrupler pour laisser passer davantage de lumière.
            L’astronomie demande de la patience mais aussi de l’entraînement.
            Au fil de vos observations, votre vision nocturne se fera meilleure.
          </p>
          <em>Eviter d'allumer des lumières style flash, préférez la lumière rouge, sinon gare à l'éblouïssement !</em>
        </div>
      </div>
      ...
      <div className="guide__section animate__animated animate__fadeInLeft">
        <h2 className="guide__section__title">On peut utiliser différents matériels pour du visuel !</h2>
      ...
      <div className="guide__section">
        <Link to="/guide/visuel">
          <h2 className="guide__section__title">On peut aussi utiliser une lunette ou un téléscope pour du visuel ! Clique sur moi pour voir ça !</h2>
        </Link>

        <Link to="/guide/photo">
          <h2 className="guide__section__title">Tu voudrais savoir comment on fait de la photo astro ? Clique sur moi pour voir ça !</h2>
        </Link>
